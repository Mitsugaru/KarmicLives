...
public abstract class CommandHandler implements CommandExecutor {
    ...
    */
   protected final Map<String, ILivesCommand> registeredCommands = new HashMap<String, ILivesCommand>();
   /**
    ...
    *           - Root plugin.
    */
   public CommandHandler(KarmicLives plugin, String cmd) {
      this.plugin = plugin;
      this.cmd = cmd;
   }
    ...
    *           command.
    */
   public void registerCommand(String label, ILivesCommand command) {
   ...
   public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
      if(args.length == 0) {
         ...
         final ILivesCommand subCommand = registeredCommands.get(subcmd);
         if(subCommand == null) {
    ...
    * Useful for when expecting a player name parameter on a root command handler
    * command.
    * 
    * @param sender
    *           - Sender of the command.
